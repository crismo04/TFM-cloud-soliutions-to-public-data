...
\begin{enumerate}
	...
	\item La \textbf{``Historia de la Inteligencia Artificial''} \label{def12} se remonta a hace casi un siglo, con la ideas de matemáticos como Alan Turing
	
	Para que sea mas visual, me gustaría resumir todos los hitos que considero importantes en esta tabla:
	\begin{table}[h]
		\centering
		\begin{tabular}{@{}r@{\hspace{1em}}|@{\hspace{1em}}p{11cm}@{}}
			...
			1982 & \textbf{RNN} - Redes neuronales con memoria \\
			...
			2018 & \textbf{GPT-1}, \textbf{BERT} - Modelos de lenguaje grandes \\
			...
			2023 & \textbf{GPT-4} - Modelo multimodale \\
			...
			2025 & \textbf{DeepSeek} - Nuevo competidor, modelos de bajo costo \\
			\    & \textbf{IA Agéntica y especializada} - agentes autónomos, tareas específicas \\
		\end{tabular}
		\caption{Historia y evolución de la IA generativa, Fuente: Adaptación de \citep{Cheok2023AIHistory}, \citep{Campbell2002DeepBlue}, \citep{Bit2BrainHistoriaIA}, \citep{Werbos1974Backpropagation}, \citep{rosenblatt1958perceptron}, \citep{Sapkota2025Agentic}, \citep{bengio2003neural}, \citep{webRIA2024Europa}. }
	\end{table}
