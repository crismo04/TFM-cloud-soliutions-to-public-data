...
% No queremos acrónimos
\newcommand{\ac}[1]{#1}
\newcommand{\acs}[1]{#1}
\newcommand{\acl}[1]{#1}
\newcommand{\acf}[1]{#1}
\else
% Comandos simples para acrónimos (sin glosstex)
\newcommand{\ac}[1]{\textbf{#1}}
\newcommand{\acs}[1]{#1}
\newcommand{\acl}[1]{#1}
\newcommand{\acf}[1]{\textbf{#1} (Forma Completa)}
\fi
...
\renewcommand{\lstlistlistingname}{Índice de bloques de código}
