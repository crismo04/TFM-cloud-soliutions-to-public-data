...
El límite temporal inferior situado en 2019 responde a la disponibilidad real del dato, ya que la red meteorológica municipal se puso en marcha en 2018 y no existen registros anteriores \citep{AytoMadrid2025Interprete}, limitando análisis que involucre meteorología a estas fechas. Como limitaciones conocidas, no existen datos de arbolado de 2018 y su estructura de ficheros cambió en enero de 2024.
...
La descarga, se estudio primero como descarga manual en los portales, pero se implementó como un proceso programático y reproducible. El portal opera sobre la plataforma CKAN \citep{CKAN2024Software}, que expone una API REST. Sobre esta, el proceso resuelve el identificador de cada conjunto y consulta sus recursos
mediante la acción \texttt{package\_show} \citep{CKAN2024ApiGuide}, descargando los datos que cumplen los criterios configurados (año, formato y subserie). 
