...
Herramientas como estas: \citep{GolemNetwork, akashCloud, rendernetwork} podrían ser útiles en proyectos con exceso de potencia de computación, ya que se podría alquilar esta a cambio de tokens que mas tarde se podría usar para las tareas intensivas cuando fuera necesario \hyperref[def8]{[Definición \ref*{def8}]}.
