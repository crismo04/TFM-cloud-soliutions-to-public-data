...
En España, los datos también muestran un aumento significativo. Según el informe económico de telecomunicaciones y audiovisual de la CNMC \citep{CNMC2026Informe}, en 2025 el tráfico de banda ancha y datos móviles creció hasta los 0.095 Zettabytes, que aun que estas cifras miden el tráfico cursado por las redes de las principales operadoras y no es directamente comparable con las estimaciones globales de datos generados  (149 Zettabytes), permiten observar ambas mediciones son elevadas, y con tendencia común de crecimiento sostenido año tras año.
