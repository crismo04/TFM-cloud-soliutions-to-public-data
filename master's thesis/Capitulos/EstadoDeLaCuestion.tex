...
A continuación detallaremos las pruebas gratuitas de los principales proveedores de servicios en la nube, información crucial para la selección tecnológica de este proyecto. \citep{free-for-dev}. Estas cifras se verificaron por ultima vez en agosto de 2026, pero al ser ofertas comerciales sujetas a cambios (como evidenció el propio desarrollo de este trabajo entre la redacción inicial de esta sección y su revisión final, varios de los servicios consultados modificaron sus límites) se genera una volatilidad que hay que considerar en proyectos que dependan de estos recursos.
...
% Empresa britanica que ademas se basa en SW abierto, soberania digital y RGPD. lanzada en 2023, pero con adopcion creciente y ultima version 3.1 en 2026
