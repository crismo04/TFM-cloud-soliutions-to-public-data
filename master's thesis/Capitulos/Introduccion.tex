...
\hyperref[cap:Resultados]{\textbf{\textit{Capítulo \ref*{cap:Resultados}: Resultados}}} En este capítulo se redactarán en detalle los resultados obtenidos en el proyecto, teniendo en cuenta todas las plataformas estudiadas y modelos usados.
