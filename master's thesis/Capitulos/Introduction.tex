...
This project studies the way in which this three technologies can combine to improve the social value.
...
\hyperref[cap:Materiales y metodos]{\textbf{Chapter \ref*{cap:MaterialesYmetodos}: Materials and Methods}}, which will cover the next two phases of analysis and implementation, specifying the technologies and datasets finally used in the project, as well as the methodology and steps followed to obtain results.

\hyperref[cap:Resultados]{\textbf{Chapter \ref*{cap:Resultados}: Results and Future Work}} In this chapter, all the results obtained in the project will be explined in detail, taking in account all the platforms and machine learning methods that has been used.

\hyperref[cap:Capitulo_5_manual_usuario]{\textbf{User manual \ref*{cap:Capitulo_5_manual_usuario}}}: This chapter is focus on the technical specification, step by step, of the solution's sintaxis with all the commands used in the project, to provide to the reader the way to reproduce the full process.
