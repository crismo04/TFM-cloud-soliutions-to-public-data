...
This project studies the way in which these three technologies can combine to improve the social value.
...
This thesis has been built using \LaTeX\space with the help of the \texis\space template. The rest of the thesis is structured in chapters as follows:
...
\hyperref[cap:Resultados]{\textbf{Chapter \ref*{cap:Resultados}: Results and Future Work}} In this chapter, all the results obtained in the project will be explained in detail, taking in account all the platforms and machine learning methods that has been used.

\hyperref[cap:Capitulo_5_manual_usuario]{\textbf{User manual \ref*{cap:Capitulo_5_manual_usuario}}}: This chapter is focus on the technical specification, step by step, of the solution's syntax with all the commands used in the project, to provide to the reader the way to reproduce the full process.
...
\hyperref[cap:conclusions]{\textbf{Conclusions and Future Work \ref*{cap:conclusions}}}: In this last chapter (which will also be available in English), the results obtained in the project will be concluded, as well as the research lines that inevitably remain open due to the breadth of the topics covered.
